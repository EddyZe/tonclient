...
— Замораживаете токены на срок (<b>7/30/60 дней</b>).

<b>Получаете доход</b>
— Ежедневные начисления (<b>до 3% в сутки</b>).
...
Если токен потеряет в стоимости — мы компенсируем <b>до 100%</b> от вашей замороженной суммы.
